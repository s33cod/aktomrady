    ...
    <Layout>
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Portfolio Page</h1>
          <p className="text-gray-600 mb-8">
            This page is coming soon! We're preparing to showcase our best printing work and client projects.
          </p>
          <Button 
