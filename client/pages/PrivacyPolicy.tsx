            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-6">Usage Information</h3>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li><strong>Service Providers:</strong> Trusted third-party vendors who assist with payment processing, shipping, and website analytics</li>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p className="mt-4">You can control cookies through your browser settings, but some features may not function properly if cookies are disabled.</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p className="mt-4">To exercise these rights, contact us at <a href="mailto:privacy@aktomrady.com" className="text-brand-cyan hover:text-brand-magenta">privacy@aktomrady.com</a></p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>Our website may contain links to third-party websites. We are not responsible for the privacy practices or content of these external sites. We encourage you to review the privacy policies of any websites you visit.</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p className="mt-4">Your continued use of our services after changes are made constitutes acceptance of the new policy.</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <p>Nigeria</p>
                    <p className="mt-4">
                      <strong>Email:</strong> <a href="mailto:privacy@aktomrady.com" className="text-brand-cyan hover:text-brand-magenta">privacy@aktomrady.com</a><br />
