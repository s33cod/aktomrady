...
export default function Quote() {
  ...
  const services = [
    { id: "large-format", name: "Large Format Prints (Banners, Billboards, Stickers)", icon: "📢" },
    { id: "business-cards", name: "Business Cards", icon: "💼" },
    { id: "flyers-brochures", name: "Flyers & Brochures", icon: "📋" },
    { id: "wedding-invitations", name: "Wedding & Event Invitations", icon: "💌" },
    { id: "branded-items", name: "Custom Branded Items & Souvenirs", icon: "🎁" },
    { id: "caps-apparel", name: "Custom Caps & Apparel", icon: "🧢" },
    { id: "wristbands", name: "Custom Wristbands", icon: "⌚" },
    { id: "political-materials", name: "Political Campaign Materials", icon: "🗳️" },
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Get Your <span className="bg-gradient-to-r from-brand-cyan via-brand-magenta to-brand-yellow bg-clip-text text-transparent">Free Quote</span>
            </h1>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Ready to bring your vision to life? Get a detailed, personalized quote for your printing project. 
          ...
          <div className="max-w-4xl mx-auto">
            {submitSuccess && (
              <div className="mb-8 p-6 bg-green-50 border border-green-200 rounded-lg flex items-center">
                ...
                <div>
                  <h3 className="text-green-800 font-semibold">Quote Request Submitted Successfully!</h3>
                  <p className="text-green-700">Thank you for your request. Our team will review your requirements and get back to you within 24 hours with a detailed quote.</p>
                </div>
              </div>
            )}
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <CardDescription className="text-white/90">
                      Please provide detailed information about your printing project for an accurate quote.
                    </CardDescription>
                  </div>
                </div>
              </CardHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Select value={quoteForm.projectType} onValueChange={(value) => setQuoteForm({...quoteForm, projectType: value})}>
                      ...
                      <div>
                        ...
                        <Select value={quoteForm.colors} onValueChange={(value) => setQuoteForm({...quoteForm, colors: value})}>
                          <SelectTrigger className="mt-1">
                      ...
                      {additionalServices.map((service) => (
                        <div key={service} className="flex items-center space-x-3">
                          <Checkbox
                            ...
                            checked={quoteForm.additionalServices.includes(service)}
                            onCheckedChange={(checked) => handleAdditionalServiceChange(service, checked as boolean)}
                          />
                          <label htmlFor={`additional-${service}`} className="text-sm cursor-pointer">
                            {service}
                          </label>
                        </div>
                      ))}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <Select value={quoteForm.hasDesign} onValueChange={(value) => setQuoteForm({...quoteForm, hasDesign: value})}>
                        <SelectTrigger className="mt-1">
                          <SelectValue placeholder="Select design status" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="have-design">Yes, I have a design ready</SelectItem>
                          <SelectItem value="need-design">No, I need design services</SelectItem>
                          <SelectItem value="need-help">I have ideas but need help</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <a href="tel:+2348029477796" className="text-brand-cyan hover:text-brand-magenta transition-colors font-medium">
                  +234.8029477796
                </a>
              </div>
              <div className="text-center">
                ...
                <a href="mailto:info@aktomrady.com" className="text-brand-magenta hover:text-brand-cyan transition-colors font-medium">
                  info@aktomrady.com
                </a>
              </div>
              <div className="text-center">
